...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PROCESSVALUES']._serialized_end=260
  _globals['_EUROTHERM']._serialized_start=263
  _globals['_EUROTHERM']._serialized_end=423
